...
import { View, StyleSheet, KeyboardAvoidingView, Platform, Text, Keyboard, TouchableWithoutFeedback } from "react-native";
import { Button, TextInput, useTheme, FAB } from 'react-native-paper';
            ...
            <SafeAreaView
                ...
                <FAB
                    ...
                    style={{
                        ...
                        top: 48,
                        left: 24,
                        backgroundColor: theme.colors.surface, // matches your theme
                        elevation: 4,
                    }}
                    small
                    onPress={() => router.back()}/>
